...
Page({
  ...
  onLoad:function(option){
    ...
    var queryEndDate = "";
    var recordPerPage = "3";
    var reqJson = { "content": { "pageIdx": "1", "recordPerPage": getApp().globalData.recordPerPage, "queryStartDate": queryStartDate, "queryEndDate": queryEndDate }, "os": "Android", "phone": "15311496135", "version": "V1.0" };
  ...
  onReachBottom:function () {
    ...
    var queryEndDate = "";
    var recordPerPage = "3";
    var reqJson = { "content": { "pageIdx": curPageIdx + 1, "recordPerPage": getApp().globalData.recordPerPage, "queryStartDate": queryStartDate, "queryEndDate": queryEndDate }, "os": "Android", "phone": "15311496135", "version": "V1.0" };
  ...
  onLoadMoreConsiliaDateDirSuccess: function (data, requestCode) {
    ...
    that.setData({ patientdateList: curPatientdateList });
